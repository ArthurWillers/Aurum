    ...
    <form wire:submit="save" class="flex flex-col gap-6">
        ...
        <div class="bg-white dark:bg-zinc-800 rounded-lg shadow-xl border border-zinc-200 dark:border-zinc-700 p-6">
            <div class="flex flex-col gap-6">
                ...
                <flux:input wire:model="description" label="Descrição" placeholder="Ex: Compras no Supermercado"
                    autofocus />
                ...
                <div x-show="expenseType === 'installment'">
                    <flux:input wire:model="total_amount" label="Valor Total (R$)" type="number" step="0.01"
                        placeholder="1200.00" />
                </div>
                ...
                <div class="grid gap-2">
                    <label for="category_id"
                        class="font-medium text-sm text-zinc-700 dark:text-zinc-200">Categoria</label>
