<div>
    ...
    @if (session('success'))
        <div
            ...
            style="display: none;"
            class="fixed bottom-5 right-5 z-50 bg-green-800 text-white text-sm font-semibold rounded-lg shadow-md px-4 py-3"
        >
            {{ session('success') }}
        </div>
    @endif
    <div class="flex justify-between items-center mb-6">
        ...
        <flux:button href="{{ route('categories.create') }}" wire:navigate.persist icon="plus" variant="primary">Nova
